# Regional root — same pattern as portal-mono live/qa/us-east-1/root.hcl
...
locals {
  ...
  backend_bucket   = get_env("TG_BACKEND_BUCKET", "tazakerv3-qa-terraform-state-use1")
  backend_dynamodb = get_env("TG_BACKEND_DYNAMODB", "tazakerv3-qa-terraform-use1-locks")
}
